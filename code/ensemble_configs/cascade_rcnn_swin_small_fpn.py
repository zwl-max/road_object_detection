...
resume_from = 'work_dirs/cascade_rcnn_swin_small_fpn_casiou0.55-0.75_gc_box_e20/epoch_4.pth'
workflow = [('train', 1)]
work_dir = './work_dirs/cascade_rcnn_swin_small_fpn_casiou0.55-0.75_gc_box_e20'
gpu_ids = range(0, 1)

...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            # dict(type='Mixup', prob=0.5, lambd=0.5,
            #      json_path='../data/train/annotations/train.json',
...
#                 skip_img_without_anno=True),
    ...
    val=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                img_scale=[(4096, 600), (4096, 800), (4096, 1100)],
                flip=True,
                transforms=[
    ...
    test=dict(
        type='Road',
        ann_file='../data/test_A/testA.json',
        img_prefix='../data/test_A/images',     
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
optimizer = dict(type='Adam', lr=3e-05)
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_r50_rfp_carafe_sac_ms_600_1100_gc_box_e20'
load_from = './detectors_htc_r50_1x_coco-329b1453.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 1)

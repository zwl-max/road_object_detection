...
def main():
    ...
    cfg.model.test_cfg.rcnn = dict(
                                ...
                                max_per_img=100)
    # 修改测试路径
    cfg.data.test.ann_file = '/data/raw_data/test_B/testB.json'
    cfg.data.test.img_prefix = '/data/raw_data/test_B/images'
    ...
    # if args.format_only:
    dataset.format_results(outputs, jsonfile_prefix='../prediction_result/result')

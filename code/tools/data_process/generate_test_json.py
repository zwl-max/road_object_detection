...
from mmdet.core import road_classes
label_ids = {name: i + 1 for i, name in enumerate(road_classes())}
...
def save(images, annotations):
    ...
    json.dump(ann, open('/data/user_data/testB.json', 'w'))
...
if __name__ == '__main__':
    test_dir = '/data/raw_data/test_B/images'

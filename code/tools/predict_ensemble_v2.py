...
def main():
    ...
    args.cfg_list = ['ensemble_configs/cascade_rcnn_r50_rfp_carafe_sac.py',  # detecotrs_r50
                     ...
                     'ensemble_configs/cascade_rcnn_x101_64x4d_dcn_fpn.py',  # x101_64x4d
                     'ensemble_configs/cascade_rcnn_r101_rfp_carafe_sac.py'] # detectors_r101
    args.checkpoint = ['ensemble_configs/detectors_r50_e20-0bd921e5.pth',
                       ...
                       'ensemble_configs/x101_64x4d_e20-dcf19539.pth',
                       'ensemble_configs/detectors_r101_e20-8908746d.pth']
    ...
    cfg.data.test.pipeline[1]['flip'] = False  # 关闭flip测试增强

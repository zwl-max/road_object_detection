...
log_level = 'INFO'
load_from = 'cascade_mask_rcnn_r101_fpn_dconv_c3-c5_1x_coco_20200204-df0c5f10.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/user_data/cascade_rcnn_r101_dcn_fpn_casiou0.55-0.75_gc_box_e20'
gpu_ids = range(0, 1)

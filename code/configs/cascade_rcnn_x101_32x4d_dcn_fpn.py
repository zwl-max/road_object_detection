...
log_level = 'INFO'
load_from = 'cascade_mask_rcnn_x101_32x4d_fpn_dconv_c3-c5_1x_coco-e75f90c8.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/user_data/cascade_rcnn_x101_32x4d_dcn_fpn_casiou0.55-0.75_gc_box_e20'
gpu_ids = range(0, 1)

...
def policy_vtest():
    ...
    # policy = [[('SolarizeAdd', 0.8, 6), ('Equalize', 0.8, 8)]] # no
    # policy = [[('Equalize', 0.0, 4), ('Cutout', 0.8, 10)]]
    # policy = [[('Posterize', 0.8, 2), ('TranslateX_BBox', 1.0, 8)]] # no
    # policy = [[('BBox_Cutout', 0.2, 10), ('Sharpness', 1.0, 8)]]
    # policy = [[('Rotate_BBox', 0.6, 8), ('Rotate_BBox', 0.8, 10)]]
    # policy = [[('Equalize', 0.8, 10), ('AutoContrast', 0.2, 10)]]
    # policy = [[('Sharpness', 0.0, 2), ('Color', 0.4, 8)]]
    # policy = [[('Equalize_Only_BBoxes', 0.8, 10), ('AutoContrast', 0.2, 10)]]
    policy = [[('Clahe', 1.0, 2)]]
    return policy
...
def policy_v5():
    ...
    policy = [
        [('BBox_Cutout', 0.2, 10), ('Sharpness', 1.0, 8)],
        [('Rotate_BBox', 0.6, 8), ('Rotate_BBox', 0.8, 10)],
        [('Clahe', 1.0, 2), ('AutoContrast', 0.2, 10)],
        [('Sharpness', 0.0, 2), ('Color', 0.4, 8)],
        [('Clahe', 1.0, 2), ('TranslateY_BBox', 1.0, 8)],
        [('AutoContrast', 0.6, 0), ('Rotate_BBox', 1.0, 6)],
        [('Clahe', 1.0, 2), ('Cutout', 0.8, 10)],
        [('Brightness', 1.0, 2), ('TranslateY_BBox', 1.0, 6)],
        [('Contrast', 0.0, 2), ('ShearY_BBox', 0.8, 0)],
        [('AutoContrast', 0.8, 10), ('Contrast', 0.2, 10)],
        [('Rotate_BBox', 1.0, 10), ('Cutout', 1.0, 10)],
